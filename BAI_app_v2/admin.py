...
from BAI_app_v2.models import ParticipantInfo, Speed, SafetynWellfare, Others, Economy, Project_info,Project_info_1, Quality, Category, PaymentDetails, UserCategory, JurySignup
